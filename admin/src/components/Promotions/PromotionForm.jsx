...
const PromotionForm = ({ initialData = {}, onSubmit, isSubmitting }) => {
  ...
  const validateForm = () => {
    ...
    } else if (formData.validFrom && formData.validUntil && new Date(formData.validFrom) > new Date(formData.validUntil)) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.type ? "border-red-500" : "border-border dark:border-border-dark"
              } rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-background-paper-dark text-text-primary dark:text-text-primary-dark`}
            >
            ...
            <p className="mt-1 text-xs text-text-secondary dark:text-text-secondary-dark">
              {formData.type === "percentage" ? "Giảm giá theo phần trăm đơn hàng" : "Giảm giá một số tiền cố định"}
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.code ? "border-red-500" : "border-border dark:border-border-dark"
              } rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-background-paper-dark text-text-primary dark:text-text-primary-dark`}
          ...
          <div>
            <label 
              ...
              className="block text-sm font-medium text-text-secondary dark:text-text-secondary-dark mb-1"
            >
              {formData.type === "percentage" ? "Phần trăm giảm giá (%)" : "Số tiền giảm giá (VNĐ)"} <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              id="discount"
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.discount ? "border-red-500" : "border-border dark:border-border-dark"
              } rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-background-paper-dark text-text-primary dark:text-text-primary-dark`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.validFrom ? "border-red-500" : "border-border dark:border-border-dark"
              } rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-background-paper-dark text-text-primary dark:text-text-primary-dark`}
            />
            {errors.validFrom && (
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-3 border ${
                errors.validUntil ? "border-red-500" : "border-border dark:border-border-dark"
              } rounded-md focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-background-paper-dark text-text-primary dark:text-text-primary-dark`}
            />
            {errors.validUntil && (
